...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'https://dashboard.emailjs.com/  =>> put your service id', 
        'https://dashboard.emailjs.com/  =>> put your template id', 
        {
          from_name: form.name,
          to_name: 'Murat',
          from_email: form.email,
          to_email: 'muratyonev@gmail.com',
          message: form.message,
        },
        'https://dashboard.emailjs.com/  =>> put your public key' 
      )
      .then(
        () => {
          setLoading(false)
